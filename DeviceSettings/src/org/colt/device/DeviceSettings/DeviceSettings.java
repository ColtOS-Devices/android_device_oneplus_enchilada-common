...
*
*/
package org.colt.device.DeviceSettings;
...
import org.colt.device.DeviceSettings.doze.DozeSettingsActivity;
import org.colt.device.DeviceSettings.preferences.ProperSeekBarPreference;
import org.colt.device.DeviceSettings.preferences.VibratorCallStrengthPreference;
import org.colt.device.DeviceSettings.preferences.VibratorNotifStrengthPreference;
import org.colt.device.DeviceSettings.preferences.VibratorStrengthPreference;
...
public class DeviceSettings extends PreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mFpsInfo) {
            ...
            Intent fpsinfo = new Intent(this.getContext(), org.colt.device.DeviceSettings.FPSInfoService.class);
            if (enabled) {
            ...
            Intent hbmIntent = new Intent(this.getContext(),
                    org.colt.device.DeviceSettings.HBMModeService.class);
            if (enabled) {
