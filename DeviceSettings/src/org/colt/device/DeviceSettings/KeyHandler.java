...
import org.colt.device.DeviceSettings.Constants;
import org.colt.device.DeviceSettings.DeviceSettings;
import org.colt.device.DeviceSettings.R;
...
public class KeyHandler implements DeviceKeyHandler {
    ...
    public static final String CLIENT_PACKAGE_PATH = "/data/misc/colt/client_package_name";
    ...
    private Context getResContext(Context context) {
        Context resContext;
        try {
            resContext = context.createPackageContext("org.colt.device.DeviceSettings",
